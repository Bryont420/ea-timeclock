/**
 * @fileoverview PasswordReset page component that handles password reset functionality
 * using a reset token. Includes interactive password validation, biometric registration
 * for mobile devices, and playful UI elements to encourage strong password creation.
 */
...
/**
 * PasswordReset page component that handles password reset functionality.
 * Features:
 ...
 * 
 * @returns The rendered PasswordReset page
 */
            ...
            if (result.success && result.data) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (canUseBiometrics && result.data && !hasBiometricRegistered(result.data.username)) {
                    ...
                    setTimeout(() => {
                        if (result.data && result.data.is_staff) {
                            navigate('/admin');
                        } else {
                            navigate('/dashboard');
                        }
