...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(50, 50, 1593, 900)
        ...
        self.timeclock_button = QPushButton("Time Clock")
        self.employee_info_button = QPushButton("Employee Info")

        self.timeclock_button.clicked.connect(self.show_employee_dashboard)
        self.employee_info_button.clicked.connect(self.show_employee_info)

        button_layout = QHBoxLayout()
        button_layout.addWidget(self.timeclock_button)
        button_layout.addWidget(self.employee_info_button)
    ...
    def show_employee_info(self):
        self.webview.setUrl(QUrl("http://timeclock:8000/employee-dashboard/info"))
